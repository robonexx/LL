  ...
  return (
    ...
    >
      <button
        ...
        shadow-[inset_0_0_0_2px_#ff6e40] text-neutral-600 hover:text-white hover:shadow-[inset_0_0_0_2px_#ff6e40] bg-white hover:bg-[#ff6e40] transition-all duration-300 drop-shadow-lg ${
